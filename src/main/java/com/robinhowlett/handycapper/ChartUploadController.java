...
import com.robinhowlett.handycapper.storage.StorageFileNotFoundException;
...
@Controller
public class ChartUploadController {

    private final StorageService storageService;

    @Autowired
    public ChartUploadController(StorageService storageService) {
    ...
    public String listUploadedFiles(Model model) throws IOException {
        model.addAttribute("files", storageService.loadAll()
                .map(path -> MvcUriComponentsBuilder.fromMethodName(ChartUploadController.class,
    ...
    public String handleFileUpload(@RequestParam("file") MultipartFile file,
        ...
        storageService.store(file, action);
